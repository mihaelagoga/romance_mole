...
> 🤗 **Model Hub Artifacts:** The trained weights, trans-tokenized base, language adapters, and optimal HMoRA router checkpoints generated by this pipeline are hosted on the Hugging Face Model Hub at [velociraptorela-208/Romance-MoLE](https://huggingface.co/velociraptorela-208/Romance-MoLE).
> 
